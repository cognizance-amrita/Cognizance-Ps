...
const Team = () => {
  ...
  let content = [
    ...
    },
    {
      ...
      post: 'Club Lead',
      dom: '',
      desc : 'I was one of the coordinators of the Open Source Domain. I have been a member of Cognizance in both the AI and OS domains before becoming a coordiantor. My interests include Web Development and Machine Learning.',
      mail: " ",
      gitHub: '',
      linkIn: '',
      insta: '',
